...
const StatsSection = ({ className }: { className?: string }) => (
  <div className={`flex flex-col lg:flex-row gap-4 justify-between text-foreground-2 ${className}`}>
    {[
      { title: "GTC Staked", value: "1.5M+", icon: <GtcIcon /> },
      { title: "Stakers", value: "123K+", icon: <StakersIcon /> },
      { title: "Passport Stamps", value: "100K+", icon: <StampsIcon /> },
    ...
    <PageRoot className="text-color-2 min-h-screen" backgroundGradientStyle="top-only">
      <div className="min-h-screen flex flex-col">
        ...
        >
          ...
          <StatsSection className="mt-10 mb-4 lg:w-full z-10" />
        </div>
        <Footer />
      </div>
    </PageRoot>
