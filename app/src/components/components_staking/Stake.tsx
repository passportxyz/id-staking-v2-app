...
export const Stake = ({ }: any) => {
    ...
    return (
        <Disclosure>
            <Disclosure.Button className={`col-span-full grid flex rounded border border-foreground-3 bg-gradient-to-r from-background  to-background-5`} onClick={handleDropDown}>
                <div className={`col-span-full grid rounded border border-foreground-3 bg-gradient-to-r from-background to-background-5`} >
            ...
            <Disclosure.Panel className={`col-span-full grid flex `}>
                <div className={`col-span-full grid flex grid-flow-col rounded border border-foreground-3 bg-gradient-to-b from-background to-background-5`} >
                    ...
                    <div className="m-2 grid-flow-row grid " >
                        ...
                        <div className="grid-flow-col grid  place-content-between">
                            <div className="grid-flow-col grid w-6/12 justify-self-start">
                                <div className="text-sm"><Button className="mx-1 text-sm" onClick={() => handleAddFixedValue(5)} >5</Button></div>
                                <div className="text-sm"><Button className="mx-1 text-sm" onClick={() => handleAddFixedValue(20)}>20</Button></div>
                                <div className="text-sm"><Button className="mx-1 text-sm" onClick={() => handleAddFixedValue(125)}>125</Button></div>
                            </div>
                            <div className="mr-20 flex grid-flow-col grid w-6/12 justify-self-end h-8">
                                <div className="text-xs mx-1">Lockup period</div>
                                <div className="text-xs h-8"><Button className="mx-1 text-xs h-8" onClick={() => handleLockedPeriod(3)} >3 months</Button></div>
                                <div className="text-xs h-8"><Button className="mx-1 text-xs h-8" onClick={() => handleLockedPeriod(6)} >6 months</Button></div>
                                <div className="text-xs h-8"><Button className="mx-1 text-xs h-8" onClick={() => handleLockedPeriod(12)} >12 months</Button></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col-span-full grid flex my-2">
                    <Button className="col-span-full  max-w-full flex" onClick={() => handleStake()} >Stake</Button>
                </div>
            </Disclosure.Panel>
