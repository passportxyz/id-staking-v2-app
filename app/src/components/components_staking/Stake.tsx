...
export const Stake = ({}: any) => {
  ...
  return (
    <Disclosure>
      <Disclosure.Button
        className={`col-span-full grid flex rounded border border-foreground-3 bg-gradient-to-r from-background  to-background-5`}
        onClick={handleDropDown}
      >
        <div
          className={`col-span-full grid rounded border border-foreground-3 bg-gradient-to-r from-background to-background-5`}
        >
          <div className="grid col-span-full grid-flow-col ">
            <div className="flex border-1 top-0">
              <img
                alt="Person Icon"
                className="max-w-11 m-2"
                src="/assets/personIcon.svg"
              />
              <div className="items-start">
                <div className="text-2xl text-color-6 md:text-xl lg:text-2xl text-left">
                  Your Stake
                </div>
                <div className="text-sm  text-left m-1 text-pretty">
                  Secure your identity by staking GTC. Higher stakes mean more
                  trust in your passport.
                </div>
              </div>
            </div>
      ...
      <Disclosure.Panel className={`col-span-full grid flex `}>
        <div
          className={`col-span-full grid flex grid-flow-col rounded border border-foreground-3 bg-gradient-to-b from-background to-background-5`}
        >
          <div className="m-2 mx-8 text-color-6 text-m  ">Amount</div>
          <div className="m-2 grid-flow-row grid ">
            <input
              className="m-2 mr-1 bg-gradient-to-t from-background-4 via-foreground-3 to-background-4"
              type="number"
              value={inputValue}
            ...
            <div className="grid-flow-col grid  place-content-between">
              <div className="grid-flow-col grid w-6/12 justify-self-start">
                ...
                <div className="text-sm">
                  <Button
                    className="mx-1 text-sm"
                    onClick={() => handleAddFixedValue(20)}
                  >
                    20
                  </Button>
                </div>
                <div className="text-sm">
                  <Button
                    className="mx-1 text-sm"
                    onClick={() => handleAddFixedValue(125)}
                  >
                    125
                  </Button>
                </div>
        ...
        <div className="col-span-full grid flex my-2">
          <Button
            className="col-span-full  max-w-full flex"
            onClick={() => handleStake()}
          >
            Stake
          </Button>
