  ...
  return (
    <Button {...rest} className={(props.className || "") + " rounded-sm"}>
      {enableEthBranding && (
        ...
        >
          <path
            d="M9.22009 22.4887V30.0001L18.4402 17.0493L9.22009 22.4887Z"
            fill="#2F3030"
          />
          <path
            d="M9.22009 11.1099V20.751L18.4402 15.2972L9.22009 11.1099Z"
            fill="black"
          />
          <path
            d="M9.22009 0V11.1098L18.4402 15.2971L9.22009 0Z"
            fill="#2F3030"
          />
          <path
            d="M9.22009 22.4887V30.0001L0 17.0493L9.22009 22.4887Z"
            fill="#828384"
          />
          <path
            d="M9.22009 11.1099V20.751L0 15.2972L9.22009 11.1099Z"
            fill="#343535"
          />
